...
const Hero = () => {
    return (
        <section
            className="relative w-full h-screen bg-cover bg-center flex flex-col gap-10 justify-center mb-10"
        ...
        >
            ...
            {/* Bottom Info Section */}
            <div className="relative mt-30 z-10 flex justify-between mx-20 gap-6 text-white">
                {/* 1st Box */}
